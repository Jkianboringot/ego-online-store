                ...
                <div class="row">
                  <div class="col">
                    <label class="inline-radio">
                      <input type="radio" name="bike_type" value="sedan" />
                      Sedan
                    </label>
                  </div>
                  ...
                  <div class="col">
                    <label class="inline-radio">
                      <input type="radio" name="bike_type" value="hatchback" />
                      Hatchback
                    </label>
                  </div>
                  ...
                  <div class="col">
                    <label class="inline-radio">
                      <input type="radio" name="bike_type" value="suv" />
